...
/////////////////////////////////////////////////////////////////////////
void shift3D(float*& field, int xRes, int yRes, int zRes)
{
  int xHalf = xRes / 2;
  int yHalf = yRes / 2;
  int zHalf = zRes / 2;
...
//////////////////////////////////////////////////////////////////////////////////////////
static void saveTile(float* const noiseTileData, int res, std::string filename)
{
	FILE* file;
...
//////////////////////////////////////////////////////////////////////////////////////////
// generate the noise tile using FFT
//////////////////////////////////////////////////////////////////////////////////////////
int main()
{
  int res = 128;
